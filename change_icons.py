...
img_rgb = ImageTk.PhotoImage(Image.open(('./icons/rgb.png')).resize((41, 41)))
...
img_lang = ImageTk.PhotoImage(Image.open(('./icons/writing.png')).resize((41, 41)))
language_button = Button(toolbar_frame, image=img_lang, command=detect_language, borderwidth=0,
                      activebackground=default_button_color, highlightbackground=default_button_color,
                      highlightthickness=0)
language_button.grid(row=0, column=5, padx=3)
tooltip_language_button = ToolTip(language_button, msg='Выбрать язык')
